...
func simpleWorkoutDescription(workout: Workout) {
    print("Your distance: \(workout.distance), in: \(workout.time)")
}

var running = RunningWorkout(distance: 2000.2, time: 10.2)
var swimming = SwimmingWorkout(distance: 8000.8, time: 20.8)
